...
static volatile uint32_t adc_scalars[SCALAR_ARRAY_SIZE] = {4271, 1067, 1994, 3185, 4358}, adc_offset[SCALAR_ARRAY_SIZE], adc_buffer_filtered[7], adc_filtered_output[7];static volatile uint32_t adc_sum_count;
